...
namespace AI
{
    public static class AI
    {
        ...
        private static void Game0()
        {
            ...
            else if(CSRight_R>=220 && CSRight_R<=255 && CSRight_G>=110 && CSRight_G<=130 && CSRight_B>=230 && CSRight_B<=255&&(LoadedObjects<6))
            {
                Duration = 49;
                CurAction =9;
            }
            else if(CSLeft_R>=230 && CSLeft_R<=255 && CSLeft_G>=70 && CSLeft_G<=90 && CSLeft_B>=235 && CSLeft_B<=255&&(LoadedObjects<6))
            {
                Duration = 49;
                CurAction =10;
            }
        ...
        private static void Game1()
        {
            ...
            else if(CSRight_R>=180 && CSRight_R<=229 && CSRight_G>=0 && CSRight_G<=50 && CSRight_B>=230 && CSRight_B<=250&&(LoadedObjects<6))
            {
                Duration = 49;
                CurAction =6;
            }
            ...
            else if(CSLeft_R>=80 && CSLeft_R<=200 && CSLeft_G>=0 && CSLeft_G<=60 && CSLeft_B>=0 && CSLeft_B<=60&&(LoadedObjects<6))
            {
                Duration = 49;
                CurAction =11;
            }
